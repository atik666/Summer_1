...
class MiniImagenet(Dataset):
    ...
    def loadCSV(self, root, mode):
        ...
        if mode == "test":
            ...
            with open("/home/atik/Documents/MAML/Summer_1/datasets/256/final_pos_classes_test_10", "rb") as fp:
                file = pickle.load(fp)
            
            file_dict = {v: k for v, k in enumerate(file)}
            
            with open("/home/atik/Documents/MAML/Summer_1/datasets/256/final_neg_classes_test_10", "rb") as fp:
